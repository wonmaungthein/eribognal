...
class QuestionnaireWizzard extends React.Component {
                    ...
                    <Grid container spacing={24} style={!this.state.error ? styles.paper : styles.paperX} >
                        ...
                        <Grid item xs={12} md={12}>
                            <FormControl fullWidth required>
                                <InputLabel htmlFor="Select Category">Select Question</InputLabel>
                                <Select
                                    value={this.state.selectedCategory}
                                    onChange={(event) => this._handleChange(event, "selectedCategory")}>
                                    <MenuItem value="Growing Project">Question one</MenuItem>
                                </Select>
                            </FormControl>
                        </Grid>
 ...
 QuestionnaireWizzard.propTypes = {
    classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(QuestionnaireWizzard);
